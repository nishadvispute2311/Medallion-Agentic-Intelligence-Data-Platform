...
@dlt.table(
    ...
    comment="Silver payments with Guardian + Drift enforcement"
)
def silver_payments():

    TABLE_NAME = "bronze_payments"

    bronze_df = dlt.read("bronze_payments")
...
@dlt.table(
    name="quarantine_payments",
    comment="payments blocked by Guardian or Drift"
)
